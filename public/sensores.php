...
<head>
    ...
    <title>Sensores da Ferrovia</title>
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link mx-lg-2 active fw-bold" aria-current="page">Sensores</a>

                            <div class="dropdown-menu">
                                <a class="nav-link mx-lg-2 active fw-bold" aria-current="page" href="sensores-ferrovia.php"> Visualizar Sensores Ferrovia
                                </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link mx-lg-2">Relatorios</a>
            ...
            <div class="container-maior">
                ...
                <div class="d-flex mt-5 mb-3 gap-5" style="align-items: center;">
                    <div class="ms-5 gap-2">
                        ...
                        <p style="font-size: 20px; margin-bottom: 8px;">Trem ID: tre06</p>
                    </div>
                    <div class="ms-2 gap-2">
                        ...
                        <p style="font-size: 20px; margin-bottom: 8px;">SENSOR_TREM_TEMPERATURA_03</p>
                        <p style="font-size: 20px; margin-bottom: 8px;">SENSOR_TREM_TEMPERATURA_04</p>
                        <p style="font-size: 20px; margin-bottom: 8px;">SENSOR_TREM_FALHA_05</p>
                        <p style="font-size: 20px; margin-bottom: 8px;">SENSOR_TREM_VELOCIDADE_06</p>
                    </div>
                    <div class="ms-2 gap-2">
                        <p style="font-size: 20px; margin-bottom: 8px;">SENSOR ID:vel1</p>
                        <p style="font-size: 20px; margin-bottom: 8px;">SENSOR ID:vel2</p>
                    ...
                    <div class="ms-2 gap-2">
                        ...
                        <p style="font-size: 20px; margin-bottom: 8px;">Tipo: Velocidade</p>
                        <p style="font-size: 20px; margin-bottom: 8px;">Tipo: Temperatura</p>
                        <p style="font-size: 20px; margin-bottom: 8px;">Tipo:</p>
