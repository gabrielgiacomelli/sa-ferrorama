    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand me-auto">
                <img class="logo navbar-brand me-auto" src="../icons/logo.png" alt="LOGO">
            </a>
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2 active fw-bold" aria-current="page" href="home.html">Home</a>
                        </li>
            ...
            <div class="sair-headder">
                <img id="img-3" src="../icons/sair.png" alt="Imagem sair">
